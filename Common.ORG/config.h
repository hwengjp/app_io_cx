...
/****************************************************************************/
/*
 * ファームのビルド定義を行うがマクロによる#ifdefは試用しない。
 *   MULTINONE 時は、_MULTINONE_U32_APP_CONFIG 変数値の設定により機能を選択
 *   通常ビルド時は IS_CONF_XXXX() を定数定義 0, 1 とし、機能を選択
 */
...
#if defined(MWLIB_MULTINONE)
#include "../../TWELITE_Apps/FirmDefs.h"
#define MW_NVMEM_FIRST_SECTOR E_MULTINONE_SECT_APPIO
#define MW_NVMEM_ALLOCATED (E_MULTINONE_SECT_APPIO_END - E_MULTINONE_SECT_APPIO)
#else
